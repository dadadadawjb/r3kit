...
from r3kit.devices.tracker.vive.xr_context import ContextObject
...
class Ultimate(TrackerBase):
    def __init__(self, id:List[str]=ULTIMATE_ROLE, name:str='Ultimate') -> None:
        ...
        self.context = ContextObject(
            instance_create_info=xr.InstanceCreateInfo(
                enabled_extension_names=[
                    # headless vive tracker extension
...
if __name__ == "__main__":
    camera = Ultimate(id=['chest', 'left_foot', 'right_foot'], name='Ultimate')
    streaming = False
    shm = False
